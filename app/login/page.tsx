      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-2xl w-full max-w-md">
        ...
        <div className="space-y-4">
          ...
          <form action="/api/auth/signin/github" method="POST">
            <button
              type="submit"
              className="w-full bg-gray-800 hover:bg-gray-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200 flex items-center justify-center border border-gray-600"
            >
